    ...
    <>
      <Helmet>
        ...
        <style>{`
          ...
          .app-shadow {
            box-shadow: 0 2px 16px 0 rgba(0,0,0,0.08), 0 1.5px 0 0 #f3f4f6;
          }
          .app-bottom-shadow {
            box-shadow: 0 -2px 16px 0 rgba(0,0,0,0.08), 0 -1.5px 0 0 #f3f4f6;
          }
          ...
          .rounded-2xl, .rounded-xl, .rounded-lg, .rounded-full, .rounded-t-2xl, .rounded-b-2xl, .rounded, .rounded-t-lg, .rounded-b-lg, .rounded-t, .rounded-b, .rounded-md, .rounded-sm {
      ...
      <div className="bg-[#fafbfc] min-h-screen flex flex-col justify-between sora relative" style={{maxWidth:'430px',margin:'0 auto',boxShadow:'0 0 24px 0 rgba(0,0,0,0.08)',height:'100vh'}}>
        {/* Header */}
        <div className="bg-[#f55a1e] w-full h-[48px] fixed top-0 left-0 flex items-center justify-between px-4 pt-2 pb-1 z-30 sora app-shadow" style={{maxWidth:'430px'}}>
        ...
        {/* Bottom Navigation */}
        <div className="fixed bottom-0 left-0 w-full bg-white flex justify-between items-center border-t border-gray-200 z-30 sora app-bottom-shadow" style={{maxWidth:'430px'}}>
