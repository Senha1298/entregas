...
const TaxaEntrega = () => {
  ...
  const [match, params] = useRoute('/a/:cpf');
  ...
  return (
    <div className="font-['Roboto',sans-serif] bg-[#F5F5F5] text-sm min-h-screen">
      <Helmet>
        <title>Taxa de Entrega - Shopee</title>
        <style>
          {`
            body {
      ...
      <div className="w-full bg-white mt-2 rounded-sm">
        <div className="p-3">
          <div className="flex items-start mb-4">
            <img src="https://i.ibb.co/Q7RXTRzN/a0e45d2fcc7fdab21ea74890cbd0d45e-2-1.png" alt="Kit EPI e Cartão Shopee" className="w-[100px] bg-[#F5F5F5] rounded-[4px]" />
          ...
          <div className="bg-[#FFF3CD] border border-[#FFEEBA] rounded-sm p-3 mb-4 text-center">
            <p className="text-[#856404] mb-2">
              <strong>Taxa de Entrega do Kit EPI e Cartão de Acesso</strong>
            </p>
            <p className="text-[#856404]">
              Realize o pagamento de <strong>R$14,90</strong> referente à taxa de entrega do Kit de Segurança (EPI) e do Cartão de Acesso para ativar seu cadastro como entregador Shopee.
            </p>
          </div>
